...
- [ ] Task 1: cargo プロジェクト初期化 + CPAL サイン波疎通
- [ ] Task 2: AudioBackend 抽象化 + NullBackend
- [ ] Task 3: Transport（BPM/バー計算・共有時計）
- [ ] Task 4: ミニ記法トークナイザ
- [ ] Task 5: ミニ記法 AST パーサ
- [ ] Task 6: パターン評価器（サイクル→イベント列）
- [ ] Task 7: メソッドチェーンパーサ + note_to_hz + 和音展開 + sound 名パース
- [ ] Task 8: ソフトシンセ Voice（基本波形 + ノイズ + ADSR + パーボイス LPF）※ティアA
