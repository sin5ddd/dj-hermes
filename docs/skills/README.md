...
| [factory-pcm-usage](./factory-pcm-usage/SKILL.md) | How to play each issue #21 batch 1 factory PCM stem (`C4:…` / unpitched FX). Not a genre recipe | `songs/skill-factory-pcm-usage.strudel` + `songs/skill-factory-pcm-lead.strudel` |
...
# Factory PCM batch 1 — how to play each stem (124 house check + separate supersaw).
