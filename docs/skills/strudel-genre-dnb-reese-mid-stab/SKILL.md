...
Playable copy: `songs/skill-dnb-reese-mid-stab.strudel`. Do not “improve” the degrees or the drum grid. Full-range Reese with sub is `reese-dark`, not a swap for this mid glue — [strudel-sound-design](../strudel-sound-design/SKILL.md).
