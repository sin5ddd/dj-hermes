...
samples/
  ...
  fx/nr.wav # unpitched noise riser (~15 s / 8 bars at 130)
  fx/rf.wav # unpitched filter riser (~15 s)
  fx/rp.wav # unpitched pitch riser (~15 s)
  fx/rw.wav # unpitched supersaw riser (~15 s)
  fx/fr.wav # unpitched FM riser (~15 s)
