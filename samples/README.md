...
Bundled extras (same format): `cp/00.wav` (house 2/4 clap), `lead-fm_pluck.wav`, `lead-fm_bell.wav` (C3 inharmonic bell), `keys-fm_ep.wav` (C3 EP), `perc-fm_metal.wav` (unpitched metal), `stab-fm_fifth.wav` (hollow C+G), `stab-fm_major.wav` (C–E–G), `reese-mid.wav`.
